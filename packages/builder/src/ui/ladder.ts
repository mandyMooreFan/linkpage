 ...
 * empty control is 45px of blank, and its only ink is the underline at the bottom. So a label is
 * **53px** above its own underline and, at the agreed 24px, only 24px below the underline of the
 * field before it — still nearer the field above than the one it names, which is the inversion
 * that started this. 32px narrows that to 32 against 53. **No value inside §1's band closes it**,
