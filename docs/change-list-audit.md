...
2. **R-6, the hours icon alone on its own line.** #195 left it with reasons, and it is the closest
   ...
   needs the ninth string §2.5 refuses; the alternative is the ~100 B flex row against 0.33 KB of
